...
export const options = {
  ...
  searchManageAll: baseUrl + '/demoAction.action?eventUploads&operationType=sjEMInfoList',
  searchManagePie: baseUrl + '/demoAction.action?eventUploads&operationType=sjEMInfoList&sjEMids=',
